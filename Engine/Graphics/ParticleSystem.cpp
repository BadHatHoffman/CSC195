...
void nc::ParticleSystem::Create(const nc::Vector2& position, float angle, float angleRange, size_t count, const nc::Color& color, float lifetime, float speedMin, float speedMax)
{
